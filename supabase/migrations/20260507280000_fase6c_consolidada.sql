-- ============================================================================
-- FASE 6C CONSOLIDADA · Calculo automatico de KPIs (re-execucao limpa)
--
-- A 6C original (20260507260000) deu rollback no Supabase por causa do
-- erro CREATE OR REPLACE VIEW. Esta migration:
--
--  1. DROP VIEW (libera pra recriar)
--  2. INSERTs idempotentes nos tipos novos
--  3. UPDATEs idempotentes no mapeamento dos KPIs
--  4. CREATE TABLE IF NOT EXISTS kpi_valores_calculados
--  5. CREATE OR REPLACE FUNCTIONs
--  6. DROP + CREATE TRIGGER
--  7. CREATE VIEW (sem OR REPLACE)
--
-- Tudo idempotente — pode rodar varias vezes sem efeito colateral.
-- ============================================================================

-- ----------------------------------------------------------------------------
-- 0. Drop view antiga pra liberar recriacao com colunas novas
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- 2. ATUALIZAR MAPEAMENTO (KPIs que estavam manual)
-- ============================================================================
...
-- ============================================================================
-- 3. TABELA kpi_valores_calculados
-- ============================================================================
...
-- ============================================================================
-- 5. calcular_kpi (funcao principal)
-- ============================================================================
...
-- ============================================================================
-- 6. recalcular_kpi (UPSERT no cache)
-- ============================================================================
...
BEGIN
  ...
  IF v_resultado ? 'erro' OR v_resultado ? 'manual' THEN RETURN v_resultado; END IF;
...
-- ============================================================================
-- 7. recalcular_kpis_por_dado (chamada pelo trigger)
-- ============================================================================
...
-- ============================================================================
-- 9. CREATE VIEW (sem OR REPLACE — drop foi feito no inicio)
-- ============================================================================
