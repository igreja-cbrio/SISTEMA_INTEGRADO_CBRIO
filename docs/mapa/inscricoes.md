...
| rota | arquivo | nível |
|---|---|---|
| `/inscricoes` | `src/pages/Inscricoes` | 1 |
| `/inscricoes/evento/:id` | `src/pages/InscricaoEventoDetalhe` | 1 |
| `/inscricoes/evento/:id/checkin` | `src/pages/InscricaoEventoCheckin` | 2 |
| `/inscricoes/totens` | `src/pages/InscricaoTotens` | 1 |
## Backend
