...
`backend/utils/` tem **206** arquivos, **189** com teste.
...
| `backend/utils/botIaRegras.js` | `src/test/botIaRegras.test.ts` `src/test/botIaVarredura.test.ts` |
| `backend/utils/botIaVarredura.js` | `src/test/botIaVarredura.test.ts` |
...
| `backend/utils/mensagemPicotada.js` | `src/test/mensagemPicotada.test.ts` |
...
| `backend/utils/respostaPesquisaVisitante.js` | — |
