...
const OUTROS_FORMULARIOS = [
  ...
  // VISITANTE (09/09/2026): um cartaz por LOCAL — o `?local=` etiqueta de onde a
  // pessoa escaneou (analítica), e cada cartaz pode virar QR dinâmico próprio.
  // A lista de locais é FECHADA no servidor (utils/visitanteRegras.LOCAIS).
