...
const CATEGORIA_MODULO = {
  ...
  espaco: 'administrativo', // legado · sinonimo de reserva_espaco
  infraestrutura: 'administrativo',
  ferias: 'rh',
  outro: 'administrativo',
};

// Map categoria legada → area_responsavel + subcategoria do novo enum (Fase A)
// Usado pra preencher area_responsavel automaticamente no INSERT.
...
router.post('/', async (req, res) => {
  try {
    ...
    // Auto-mapeia area_responsavel + subcategoria a partir da categoria
    // (se cliente nao mandou explicito)
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        area_solicitante,
        // Campos novos · trigger calcula SLA + precisa_aprovacao_financeira
