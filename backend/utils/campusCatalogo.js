...
adicionar('voluntariado', 'local', 'mem_voluntarios vol_profile_campi vol_pco_service_type_campi vol_services vol_teams vol_schedules vol_check_ins vol_positions vol_team_members vol_availability vol_escala_templates vol_escala_template_tipos vol_escala_template_itens vol_escala_template_item_pessoas vol_escala_template_liderancas vol_escala_culto_itens vol_inscricoes vol_inscritos vol_servicos_historico vol_area_supervisores vol_pco_mapa vol_email_disparos vol_email_disparo_destinatarios vol_sync_logs vol_background_checks vol_training_checkins', 'igreja_id');
adicionar('voluntariado', 'pendente', 'vol_config vol_email_config vol_inatividade vol_user_roles vol_volunteer_qrcodes vol_parabens');
