...
app.use('/api', require('./middleware/campusSuperficie').criarCampusSuperficie({ cobertura: [
  { metodo: 'GET', caminho: '/api/voluntariado/services' },
  { metodo: 'GET', caminho: '/api/voluntariado/services/upcoming' },
  { metodo: 'GET', caminho: '/api/voluntariado/services/today' },
  { metodo: 'GET', caminho: '/api/voluntariado/services/checkin-window' },
  { metodo: 'GET', caminho: '/api/voluntariado/schedules' },
  { metodo: 'GET', caminho: '/api/voluntariado/check-ins' },
  { metodo: 'GET', caminho: '/api/voluntariado/relatorio-dados' },
  { metodo: 'GET', caminho: '/api/voluntariado/my-schedules' },
  { metodo: 'GET', caminho: '/api/voluntariado/my-services' },
  { metodo: 'GET', caminho: '/api/voluntariado/my-availability' },
  { metodo: 'GET', caminho: '/api/voluntariado/my-check-ins' },
  { metodo: 'POST', caminho: '/api/voluntariado/my-availability' },
  { metodo: 'DELETE', caminho: '/api/voluntariado/my-availability/:id' },
  { metodo: 'POST', caminho: '/api/voluntariado/frequencia/sync-pco' },
  ...
  { metodo: 'GET', caminho: '/api/totem-kids/edit-senha/status' },
  { metodo: 'POST', caminho: '/api/totem-kids/edit-senha' },
  { metodo: 'POST', caminho: '/api/totem-kids/edit-senha/verificar' },
  { metodo: 'GET', caminho: '/api/totem-kids/etiqueta-config' },
  { metodo: 'PUT', caminho: '/api/totem-kids/etiqueta-config' },
  { metodo: 'POST', caminho: '/api/totem-kids/etiqueta-config/logo' },
  { metodo: 'POST', caminho: '/api/totem-kids/etiqueta-config/logo/remover' },
  { metodo: 'POST', caminho: '/api/totem-kids/codigos-reservados' },

  { metodo: 'GET', caminho: '/api/batismo-fotos' },
  { metodo: 'GET', caminho: '/api/batismo-fotos/:data/fotos' },
  { metodo: 'POST', caminho: '/api/batismo-fotos/:data/fotos' },
  { metodo: 'DELETE', caminho: '/api/batismo-fotos/:data/fotos/:arquivo' },
  { metodo: 'GET', caminho: '/api/public/batismo/acesso' },
  { metodo: 'GET', caminho: '/api/app/campus/batismo/me' },
  { metodo: 'GET', caminho: '/api/app/campus/batismo/:id/fotos' },
  { metodo: 'POST', caminho: '/api/app/campus/batismo/:id/checkin' },
  { metodo: 'GET', caminho: '/api/app/batismo/papel' },
  { metodo: 'GET', caminho: '/api/app/batismo/gestao' },
  { metodo: 'POST', caminho: '/api/app/batismo/gestao/pessoas' },
  { metodo: 'POST', caminho: '/api/app/batismo/gestao/:id/aprovar' },
  { metodo: 'POST', caminho: '/api/app/batismo/gestao/:id/checkin' },
  { metodo: 'PUT', caminho: '/api/app/batismo/gestao/:id' },
  { metodo: 'DELETE', caminho: '/api/app/batismo/gestao/:id' },
  ...
  { metodo: 'GET', caminho: '/api/public/batismo/textos' },
  { metodo: 'POST', caminho: '/api/public/batismo' },
  { metodo: 'GET', caminho: '/api/app/campus/batismo/horarios' },
  { metodo: 'POST', caminho: '/api/app/campus/batismo/inscricoes' },
  ...
  { metodo: 'GET', caminho: '/api/app/culto/agora' },
  ...
  { metodo: 'GET', caminho: '/api/cuidados/acompanhamentos' },
  { metodo: 'GET', caminho: '/api/cuidados/convertidos' },
  { metodo: 'GET', caminho: '/api/cuidados/jornada180' },
  { metodo: 'GET', caminho: '/api/cuidados/visitas' },
  { metodo: 'GET', caminho: '/api/cuidados/pedidos' },
  { metodo: 'GET', caminho: '/api/cuidados/j180/turmas' },
  { metodo: 'GET', caminho: '/api/cuidados/j180/turmas/:id' },
  { metodo: 'GET', caminho: '/api/cuidados/j180/turmas/:id/encontros' },
  { metodo: 'GET', caminho: '/api/staff/me' },
  { metodo: 'GET', caminho: '/api/staff/me/qr' },
  { metodo: 'GET', caminho: '/api/staff/me/documentos' },
  { metodo: 'GET', caminho: '/api/staff/dados-pessoais' },
  { metodo: 'POST', caminho: '/api/staff/push-token' },
  { metodo: 'POST', caminho: '/api/cuidados/visitas' },
  { metodo: 'PATCH', caminho: '/api/cuidados/visitas/:id' },
  { metodo: 'DELETE', caminho: '/api/cuidados/visitas/:id' },
  { metodo: 'POST', caminho: '/api/cuidados/pedidos' },
  { metodo: 'DELETE', caminho: '/api/cuidados/pedidos/:id' },
  { metodo: 'GET', caminho: '/api/next/turmas' },
  { metodo: 'GET', caminho: '/api/next/turmas/:id' },
  { metodo: 'GET', caminho: '/api/next/matriculas' },
  { metodo: 'GET', caminho: '/api/next/lista-espera' },
  { metodo: 'POST', caminho: '/api/next/eventos' },
  { metodo: 'PUT', caminho: '/api/next/eventos/:id' },
  { metodo: 'POST', caminho: '/api/next/eventos/auto-create-mes' },
  { metodo: 'POST', caminho: '/api/next/inscricoes' },
  { metodo: 'POST', caminho: '/api/next/inscricoes/:id/checkin' },
  { metodo: 'DELETE', caminho: '/api/next/inscricoes/:id/checkin' },
  { metodo: 'POST', caminho: '/api/next/turmas' },
  { metodo: 'DELETE', caminho: '/api/next/turmas/:id' },
  { metodo: 'PATCH', caminho: '/api/next/encontros/:id' },
  { metodo: 'PUT', caminho: '/api/next/encontros/:id/presencas' },
  { metodo: 'POST', caminho: '/api/next/encontros/:id/presenca' },
  { metodo: 'POST', caminho: '/api/next/matriculas' },
  { metodo: 'PATCH', caminho: '/api/next/matriculas/:id/contato' },
  { metodo: 'DELETE', caminho: '/api/next/matriculas/:id' },
  { metodo: 'PATCH', caminho: '/api/next/turmas/:id' },
  { metodo: 'POST', caminho: '/api/next/matriculas/:id/transferir' },
  { metodo: 'PATCH', caminho: '/api/next/matriculas/:id' },
  { metodo: 'GET', caminho: '/api/grupos' },
  { metodo: 'GET', caminho: '/api/grupos/buscar' },
  { metodo: 'GET', caminho: '/api/grupos/:id' },
  { metodo: 'GET', caminho: '/api/grupos/kpis/relatorio' },
  { metodo: 'GET', caminho: '/api/grupos/kpis/temporada-metricas' },
  { metodo: 'GET', caminho: '/api/grupos/kpis/temporada-series' },
  { metodo: 'GET', caminho: '/api/grupos/kpis/sem-presenca' },
  { metodo: 'GET', caminho: '/api/grupos/temporadas/consolidado' },
  { metodo: 'POST', caminho: '/api/grupos/temporadas/:temporada/consolidar' },
  { metodo: 'GET', caminho: '/api/next/eventos' },
  { metodo: 'GET', caminho: '/api/next/inscricoes' },
  { metodo: 'GET', caminho: '/api/next/inscricoes/:id' },
  { metodo: 'GET', caminho: '/api/next/indicacoes' },
  { metodo: 'GET', caminho: '/api/next/dashboard' },
  { metodo: 'GET', caminho: '/api/next/pessoas' },
  { metodo: 'GET', caminho: '/api/next/curso' },
  { metodo: 'PUT', caminho: '/api/next/pessoa/:id/aulas' },
  { metodo: 'PUT', caminho: '/api/next/inscricoes/:id' },
  { metodo: 'POST', caminho: '/api/next/convertidos/:id/resolver' },
  { metodo: 'DELETE', caminho: '/api/next/convertidos/:id/resolver' },
  { metodo: 'DELETE', caminho: '/api/kpis/batismos/horarios/:id' },
  { metodo: 'PUT', caminho: '/api/kpis/batismos/em-massa' },
  { metodo: 'POST', caminho: '/api/kpis/batismos/:id/checkin' },
  { metodo: 'GET', caminho: '/api/notificacoes' },
  { metodo: 'GET', caminho: '/api/notificacoes/count' },
  { metodo: 'PATCH', caminho: '/api/notificacoes/:id/ler' },
  { metodo: 'PATCH', caminho: '/api/notificacoes/ler-todas' },
  { metodo: 'GET', caminho: '/api/kpis/batismos/cobertura-convertidos' },
  { metodo: 'GET', caminho: '/api/kpis/batismos' },
  { metodo: 'GET', caminho: '/api/kpis/batismos/horarios' },
  { metodo: 'POST', caminho: '/api/kpis/batismos/horarios' },
  { metodo: 'PATCH', caminho: '/api/kpis/batismos/horarios/:id' },
  { metodo: 'GET', caminho: '/api/kpis/batismos/checkin/do-dia' },
  { metodo: 'POST', caminho: '/api/kpis/batismos' },
  { metodo: 'PUT', caminho: '/api/kpis/batismos/:id' },
