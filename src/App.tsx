...
const ApresentacoesContexto = lazyWithRetry(() => import('./pages/apresentacoes/ApresentacoesContexto'));
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/admin/apresentacoes/contexto" element={<ModuleGuard moduleSlug="apresentacoes"><Suspense fallback={<Loading />}><ApresentacoesContexto /></Suspense></ModuleGuard>} />
