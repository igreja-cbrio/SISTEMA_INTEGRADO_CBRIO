...
const PAGES: SearchItem[] = [
  ...
  { label: 'Execução do Planejamento', description: 'Propostas aprovadas · detalhe e fases do Projeto/Evento vinculado', path: '/planejamento-execucao', icon: FolderKanban, category: 'Projetos e Eventos' },
  ...
  // ⚠️ "Visitantes" saiu da busca junto com o item de menu (11/09/2026) — ver
  // o comentário no AppShell. A porta do visitante é a aba dentro de Cuidados.
